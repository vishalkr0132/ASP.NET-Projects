                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Gallery Edit</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner" style=" padding-bottom:200px;">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i>Add Gallery</a></li>
                                   <%-- <li><a href="#reviews"><i class="fa fa-file-image-o" aria-hidden="true"></i> Pictures</a></li>--%>
                                    <li><a href="#INFORMATION"><i class="fa fa-eye" aria-hidden="true"></i>View Gallery</a></li>
                                </ul>
...
<asp:TextBox ID="txtOType" runat="server" class="form-control" Text='<%#Eval("OfferType") %>'  Width="200px"></asp:TextBox>
 ...
 <asp:Label ID="lblOType" runat="server"  Text='<%#Eval("OfferType") %>'/>
  ...
  <ItemTemplate>
  <asp:Image ID="Image1" runat="server" Height="50" ImageUrl='<%# Eval("imgurl", "galleryImg/{0}") %>'  class="img-thumbnail" />
  </ItemTemplate>
  <EditItemTemplate>
