<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddImageSlider.aspx.cs" Inherits="Admin_AddImageSlider" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Slider Edit</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner" style=" padding-bottom:200px;">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i>Add Image Slider</a></li>
                                   <%-- <li><a href="#reviews"><i class="fa fa-file-image-o" aria-hidden="true"></i> Pictures</a></li>--%>
                                    <li><a href="#INFORMATION"><i class="fa fa-eye" aria-hidden="true"></i>View Image Slider</a></li>
                                </ul>
                                                ...
                                                <div class="review-content-section">
                                                 <div class="input-group mg-b-pro-edt">
                                                       ...
                                                       <asp:FileUpload ID="FileUpload1" runat="server" />  
                                                        <asp:TextBox ID="txtOferType" runat="server" type="text" class="form-control" placeholder="Discription"></asp:TextBox>        
                                                    </div>
                                                </div>
                                            </div>
...
<asp:ImageButton ID="imgbtnDelete"  CommandName="Delete" Text="Edit" runat="server" ImageUrl="images/delete.jpg" ToolTip="Delete" Height="20px" Width="20px" OnClientClick="return confirm('Are You Sure To Delete')" />
 ...
 <EditItemTemplate>
<asp:TextBox ID="txtOType" runat="server" class="form-control" Text='<%#Eval("OfferType") %>'  Width="200px"></asp:TextBox>
 </EditItemTemplate>
 <ItemTemplate>
 <asp:Label ID="lblOType" runat="server"  Text='<%#Eval("OfferType") %>'/>
 </ItemTemplate>
 </asp:TemplateField>
 
   <asp:TemplateField HeaderText = "Image">
  <ItemTemplate>
  <asp:Image ID="Image1" runat="server" Height="50" ImageUrl='<%# Eval("imgurl", "sliderImg/{0}") %>'  class="img-thumbnail" />
  </ItemTemplate>
  <EditItemTemplate>
