                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">News Edit</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner" style=" padding-bottom:200px;">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i>Add News</a></li>
                                   <%-- <li><a href="#reviews"><i class="fa fa-file-image-o" aria-hidden="true"></i> Pictures</a></li>--%>
                                    <li><a href="#INFORMATION"><i class="fa fa-eye" aria-hidden="true"></i>View News</a></li>
                                </ul>
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                       <span class="input-group-addon"><i class="fa fa-image" aria-hidden="true"></i></span>
                                                        ...
                                                        <asp:TextBox ID="TextBox1" runat="server" type="text" class="form-control" placeholder="title"></asp:TextBox>        
                                                    </div><div class="input-group mg-b-pro-edt">
                                                       <span class="input-group-addon"><i class="fa fa-image" aria-hidden="true"></i></span>
                                                       
                                                        <asp:TextBox ID="TextBox2" runat="server" type="text" class="form-control" placeholder="Discription"></asp:TextBox>        
                                                    </div>
                                                </div>
                                            </div>
...
<asp:ImageButton ID="imgbtnDelete"  CommandName="Delete" Text="Edit" runat="server" ImageUrl="images/delete.jpg" ToolTip="Delete" Height="20px" Width="20px" OnClientClick="return confirm('Are You Sure To Delete')" />
 ...
 <EditItemTemplate>
<asp:TextBox ID="title1" runat="server" class="form-control" Text='<%#Eval("title") %>'  Width="200px"></asp:TextBox>
 </EditItemTemplate>
 <ItemTemplate>
 ...
 <EditItemTemplate>
<asp:TextBox ID="description1" runat="server" class="form-control" Text='<%#Eval("description") %>'  Width="200px"></asp:TextBox>
 </EditItemTemplate>
 <ItemTemplate>
 <asp:Label ID="description2" runat="server"  Text='<%#Eval("description") %>'/>
 </ItemTemplate>
 </asp:TemplateField>
 
   <asp:TemplateField HeaderText = "Image1 Slider">
  <ItemTemplate>
  <asp:Image ID="Image1" runat="server" Height="50" ImageUrl='<%# Eval("imgurl", "../Img-Slider/{0}") %>'  class="img-thumbnail" />
  </ItemTemplate>
  <EditItemTemplate>
