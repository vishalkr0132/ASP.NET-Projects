...
public partial class Admin_AddGallery : System.Web.UI.Page
{
    ...
    {
        string fileName = "";
        String savePath = Server.MapPath("../galleryImg/");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (txtOferType.Text != "")
        {
            ...
            string qry = "insert into GalleryMaster(OfferType, imgurl) values(@OfferType, @imgurl)";
    ...
    protected void gridvoperator_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            cn.Open();
            string qry = "update GalleryMaster set OfferType=@a, imgurl=@img1 where id=" + Id;
    ...
    protected void gridvoperator_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            cn.Open();
            SqlCommand cmd = new SqlCommand("delete from GalleryMaster where id=" + id, cn);
