<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ProductEntry.aspx.cs" Inherits="Admin_ProductEntry" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Product Entery</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i>Add Product Details</a></li>
                                    <li><a href="#INFORMATION"><i class="fa fa-eye" aria-hidden="true"></i>View Product Details</a></li>
                                </ul>
                                                ...
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                      <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                       <asp:DropDownList ID="DropDownList1" runat="server" Width="100%" Height="40px">
                                                     </asp:DropDownList>
                                                    </div>
                                                       <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-product-hunt" aria-hidden="true"></i></span>
                                                        <asp:TextBox ID="txtType" runat="server" type="text" class="form-control" placeholder="Product Type"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<asp:ImageButton ID="imgbtnDelete"  CommandName="Delete" Text="Edit" runat="server" ImageUrl="images/delete.jpg" ToolTip="Delete" Height="20px" Width="20px" OnClientClick="return confirm('Are You Sure To Delete')" />
  ...
  <asp:TemplateField HeaderText="Product Sub Category">
 <ItemTemplate>
 <asp:Label ID="lblpstype" runat="server"  Text='<%#Eval("ProductType") %>'  Width="200px"/>
 </ItemTemplate>
 </asp:TemplateField>

 <asp:TemplateField HeaderText="Type">
 <EditItemTemplate>
<asp:TextBox ID="txttype" runat="server" class="form-control" Text='<%#Eval("Type") %>'  Width="200px"></asp:TextBox>
 </EditItemTemplate>
 <ItemTemplate>
 ...
 <EditItemTemplate>
<asp:TextBox ID="txtdiscription" runat="server" class="form-control" Text='<%#Eval("Description") %>'  Width="200px"></asp:TextBox>
 </EditItemTemplate>
 <ItemTemplate>
 <asp:Label ID="lbldiscription" runat="server"  Text='<%#Eval("Description") %>'/>
  ...
  <ItemTemplate>
  <asp:Image ID="Image1" runat="server" Height="50" ImageUrl='<%# Eval("imgurl", "../Product-Img/{0}") %>'  class="img-thumbnail" />
  </ItemTemplate>
  <EditItemTemplate>
