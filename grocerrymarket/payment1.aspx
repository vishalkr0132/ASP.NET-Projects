        ...
        <div id="parentHorizontalTab">
								...
								<form class="cc-form">
									<div class="clearfix">
										<div class="form-group form-group-cc-number">
											<label>Name</label>
											<asp:TextBox ID="TextBox1" runat="server" class="form-control"  placeholder="Please Enter Your Name" required=""></asp:TextBox>
											<%--<input class="form-control" placeholder="Please Enter Your Name" type="text"><span class="cc-card-icon"></span>--%>
										</div>
										<div class="form-group form-group-cc-cvc">
											<label>Mobile</label>
										   <asp:TextBox ID="TextBox2" runat="server" class="form-control"  placeholder="Please Enter Your Mobile" required=""></asp:TextBox>
									...
									<div class="clearfix">
										<div class="form-group form-group-cc-name">
											<label>State</label>
											<asp:TextBox ID="TextBox3" runat="server" class="form-control"  placeholder="Please Enter Your State" required=""></asp:TextBox>
											<%--<input class="form-control" type="text" placeholder="Please Enter Your State">--%>
										</div>
										<div class="form-group form-group-cc-date">
											<label>City With Pincode</label>
											<asp:TextBox ID="TextBox4" runat="server" class="form-control"  placeholder="Please Enter Your City With Pincode" required=""></asp:TextBox>
									...
									<asp:Button ID="Button1" runat="server" class="btn btn-primary submit" Text="Proceed Payment" OnClick="Button1_Click" />
			...
			<label>
				<input class="i-check" type="checkbox" checked="">Add to My Cards
									...
									<%--<input class="btn btn-primary submit" type="submit" class="submit" value="Proceed Payment">--%>
									<asp:Button ID="Button2" runat="server" class="btn btn-primary submit" Text="Proceed Payment" />
								</form>
							</div>
						</div>
